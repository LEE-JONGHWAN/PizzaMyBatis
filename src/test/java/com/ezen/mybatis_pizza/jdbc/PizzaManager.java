...
public class PizzaManager {
	...
	private static int createOrderItem(int order_Id, String menu_name, Connection conn) 
					throws SQLException{
		
		var sb = new StringBuilder("insert into order_item ");
		  
		sb.append("(order_id, menu_id)select ");
		sb.append(order_Id);
		sb.append(", pm.menu_id ");
	...
	private static int createPizzaOrder(String cust_name, Connection conn)
			throws SQLException {
